...
1. یکی از راه‌های افزایش کیفیت کد پیدا کردن نشانه‌های کد کثیف در برنامه و سپس ریفکتور کردن برنامه به صورتی که که نشانه‌ی کد کثیف از بین برود. به این نشانه‌ها [Code Smell](https://en.wikipedia.org/wiki/Code_smell) می‌گوییم. در این مرحله در مورد Code Smell های زیر مطالعه کنید و مشخص کنید کدام یک از موارد زیر در کدی که برای فاز اول زدید به وجود آمده است؟
