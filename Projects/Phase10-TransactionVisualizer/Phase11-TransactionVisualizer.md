...
## ۱- چرا به صورت گراف تراکنش‌ها را نشان دهیم؟
...
## ۲- ساختار داده و تعریف اجزای آن به عنوان بخش‌های گراف
...
<br>
ما با پیاده‌سازی این فاز، بعد از این که توانستیم هر رکورد را به صورت یک دمبل نشان بدهیم، آماده می‌شویم تا در آینده برنامه مجهز به ابزارهای تحلیل کنیم.
