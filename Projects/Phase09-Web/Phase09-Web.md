...
در این قسمت می‌خواهیم برای پروژه‌ی شما که در فاز قبل کوئری را از طریق کنسول دریافت می‌کرد یک API بنویسیم. هم چنین نتایج جستجو نیز در جواب API فرستاده شود.
