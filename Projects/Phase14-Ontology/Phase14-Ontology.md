...
<br>
با بارگذاری این فایل در سیستم، نگرش دریافت‌کننده محصول به پدیده‌های سیستم مشخص می‌شود. یعنی اگر محصول نهایی به دست مشتری رسید، او همان ابتدای کار آنتولوژی را با دادن این فایل ست می‌کند تا سیستم آماده مراحل بعدی شود.
