...
<p style="text-align:center;"><img src="qrcode.png" alt="Logo" width="150" height="150" align="center"></p>

شما می‌توانید بگویید من یک صفحه سفید با خطوط مشکی می‌بینم. اما می‌توانید آنتولوژی خود را تغییردهید و بگویید این یک صفحه مشکی با خطوط سفید است.اجزای اصلی تشکیل‌دهنده این آنتولوژی رنگ و خط بودند. و شما تصویر را به وسیله این دو تعریف‌کردید. شما می‌توانستید دیدگاه را کلا تغییردهید و تصویر را با تعریف اشکال موجود در آن تفسیرکنید. مثلا بگویید از تعدادی مربع و مستطیل تشکیل شده‌است.
<br>
