This issue template is based on [Phase01-Search.md](./Phase01-Search.md) contents. Go to [Issue Repo](https://github.com/Star-Academy/codestar-intern-issues/issues/new/choose) and click on Get started for this phase.
