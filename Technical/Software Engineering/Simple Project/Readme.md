...
- برای بالا بردن دقت جستجو تمام Document ‌های ورودی را Uppercase کنید.
...
برنامه‌ای که در تمرین قبل نوشتید را به نحوی توسعه دهید که سه نوع ورودی از کاربر بگیرد:
   ...
   1. کلماتی که حداقل یکی از آن‌ها می‌بایست در نتیجه وجود داشته باشند، با پیشوند `+` مشخص می‌شوند.
